...
type ConvertServiceClient interface {
	Convert(ctx context.Context, in *Money, opts ...grpc.CallOption) (*Money, error)
}
...
type ConvertServiceServer interface {
	Convert(context.Context, *Money) (*Money, error)
...
func (UnimplementedConvertServiceServer) Convert(context.Context, *Money) (*Money, error) {
